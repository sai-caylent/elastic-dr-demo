...
variable "alarm_actions" {
  description = "A list of ARNs to use as actions in the event of an alarm. Can be SNS topics, Lambda functions, etc. Leave blank to do nothing by default."
  type        = list(string)
  default     = []
}

variable "cpu_alarm_threshold" {
  description = "Set off a CloudWatch Metric alarm if the instance's CPU utilization exceeds this threshold for a prolonged period. If set to 0, this alarm is disabled for the instance."
  type        = number
  default     = 0
}

variable "cpu_alarm_evaluation_periods" {
  description = "Number of 60 second evaluation periods the CPU utilization needs to exceed the alarm threshold before the alarm is triggered."
  type        = number
  default     = 5
}

variable "memory_alarm_threshold" {
  description = "Set off a CloudWatch Metric alarm if the instance's memory utilization exceeds this threshold for a prolonged period. If set to 0, this alarm is disabled for the instance."
  type        = number
  default     = 0
}

variable "disk_space_alarm_evaluation_periods" {
  description = "Number of 60 second evaluation periods the disk space utilization needs to exceed the alarm threshold before the alarm is triggered."
  type        = number
  default     = 5
}

variable "disk_space_alarm_threshold" {
  description = "Set off a CloudWatch Metric alarm if the instance's free disk space (percentage) falls under this threshold for a prolonged period. If set to 0, this alarm is disabled for the instance."
  type        = number
  default     = 0
}

variable "memory_alarm_evaluation_periods" {
  description = "Number of 60 second evaluation periods the memory utilization needs to exceed the alarm threshold before the alarm is triggered."
  type        = number
  default     = 5
}

variable "network_alarm_evaluation_periods" {
  description = "Number of 60 second evaluation periods the network utilization needs to exceed the alarm threshold before the alarm is triggered."
  type        = number
  default     = 5
}

variable "network_alarm_threshold" {
  description = "Set off a CloudWatch Metric alarm if the instance's network utilization exceeds this threshold (in Gbit/s) for a prolonged period. If set to 0, this alarm is disabled for the instance."
  type        = number
  default     = 0
}

variable "restart_on_instance_failure" {
  description = "Should the instance be restarted in the event of a status check failure?"
  type        = bool
  default     = false
}
